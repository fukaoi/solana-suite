...
(function (Transaction) {
    Transaction.parseAccountData = (data) => {
        console.log(data);
    ...
    callback) => {
        return node_1.Node.getConnection().onAccountChange(pubkey, (data, _) => {
            callback(data, _);
            const parsed = Transaction.parseAccountData(data.data);
            console.log(parsed);
            console.log(parsed.token);
            console.log(parsed.owner.toBase58());
    ...
    Transaction.confirmedSig = (signature, commitment = 'max') => __awaiter(this, void 0, void 0, function* () {
        yield node_1.Node.getConnection().confirmTransaction(signature, commitment);
    });
