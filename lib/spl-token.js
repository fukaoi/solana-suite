...
(function (SplToken) {
    ...
    SplToken.subscribeAccount = (pubkey, callback) => {
        return node_1.Node.getConnection().onAccountChange(pubkey, () => __awaiter(this, void 0, void 0, function* () {
            const res = yield SplToken.getTransferHistory(pubkey, 1);
            callback(res[0]);
        }));
    };
    SplToken.unsubscribeAccount = (subscribeId) => node_1.Node.getConnection().removeAccountChangeListener(subscribeId);
    SplToken.getTransferHistory = (pubkey, limit) => __awaiter(this, void 0, void 0, function* () {
        const transactions = yield transaction_1.Transaction.getAll(pubkey, limit);
        const hist = [];
    ...
    SplToken.create = (source, totalAmount, mintDecimal, authority = source.publicKey) => __awaiter(this, void 0, void 0, function* () {
        const connection = node_1.Node.getConnection();
        const token = yield spl_token_1.Token.createMint(connection, source, authority, null, mintDecimal, spl_token_1.TOKEN_PROGRAM_ID);
    ...
    SplToken.transfer = (tokenKey, source, dest, amount, mintDecimal, instruction) => __awaiter(this, void 0, void 0, function* () {
        ...
        const param = spl_token_1.Token.createTransferCheckedInstruction(spl_token_1.TOKEN_PROGRAM_ID, sourceTokenAccount, tokenKey, destTokenAccount, source.publicKey, [source], amount, mintDecimal);
