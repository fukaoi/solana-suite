...
(function (MetaplexMetaData) {
    MetaplexMetaData.getByMintKey = (tokenKey) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const metaAccount = (yield wallet_1.Wallet.findMetaplexAssocaiatedTokenAddress(tokenKey)).toBase58();
        // get rent data in a metaAccount
        const nfts = yield node_1.Node.getConnection().getParsedAccountInfo(new web3_js_1.PublicKey(metaAccount));
    ...
    MetaplexMetaData.getByOwner = (ownerPubKey) => __awaiter(this, void 0, void 0, function* () {
        ...
        const tokens = yield node_1.Node.getConnection().getParsedTokenAccountsByOwner(new web3_js_1.PublicKey(ownerPubKey), { programId: constants_1.Constants.SPL_TOKEN_PROGRAM_ID });
        const matches = [];
    ...
    MetaplexMetaData.update = (data, newUpdateAuthority, primarySaleHappened, tokenKey, updateAuthority, signers) => (instructions) => __awaiter(this, void 0, void 0, function* () {
        ...
        inst.push(spl_token_1.Token.createMintToInstruction(constants_1.Constants.SPL_TOKEN_PROGRAM_ID, new web3_js_1.PublicKey(tokenKey), associatedToken, new web3_js_1.PublicKey(updateAuthority), signers, 1));
        const metaAccount = (yield wallet_1.Wallet.findMetaplexAssocaiatedTokenAddress(tokenKey)).toBase58();
