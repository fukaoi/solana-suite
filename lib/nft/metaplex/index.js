...
(function (Metaplex) {
    ...
    const init = (instructions, mintAccount, payer, owner = payer, freezeAuthority = payer) => __awaiter(this, void 0, void 0, function* () {
        const decimals = 0;
        instructions.push(spl_token_1.Token.createInitMintInstruction(constants_1.Constants.SPL_TOKEN_PROGRAM_ID, mintAccount, decimals, new web3_js_1.PublicKey(owner), new web3_js_1.PublicKey(freezeAuthority)));
    ...
    Metaplex.create = (payer, signers) => (instructions) => __awaiter(this, void 0, void 0, function* () {
        ...
        return { instructions: inst, signers, tokenKey: mintKey };
    });
    Metaplex.mint = (data, owner) => __awaiter(this, void 0, void 0, function* () {
        ...
        return { mintKey: txsign.tokenKey, signature };
    });
