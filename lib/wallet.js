...
(function (Wallet) {
    ...
    Wallet.createSigners = (signerSecrets) => signerSecrets.map(s => s.toKeypair());
    Wallet.getBalance = (pubkey, unit = 'sol') => __awaiter(this, void 0, void 0, function* () {
        const balance = yield node_1.Node.getConnection().getBalance(new web3_js_1.PublicKey(pubkey));
        switch (unit) {
    ...
    Wallet.findMetaplexAssocaiatedTokenAddress = (tokenId) => __awaiter(this, void 0, void 0, function* () {
        ...
        return (yield web3_js_1.PublicKey.findProgramAddress([
            ...
            new web3_js_1.PublicKey(constants_1.Constants.METAPLEX_PROGRAM_ID).toBuffer(),
            tokenIdPublicKey.toBuffer(),
        ], new web3_js_1.PublicKey(constants_1.Constants.METAPLEX_PROGRAM_ID)))[0];
    });
