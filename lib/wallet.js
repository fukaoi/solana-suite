...
(function (Wallet) {
    ...
    Wallet.requestAirdrop = (pubkey, airdropAmount = Wallet.DEFAULT_AIRDROP_AMOUNT) => __awaiter(this, void 0, void 0, function* () {
        let amount = 0;
        if (airdropAmount) {
            amount = airdropAmount * web3_js_1.LAMPORTS_PER_SOL;
        }
        else {
            amount = Wallet.DEFAULT_AIRDROP_AMOUNT;
        }
        console.debug('Now airdropping...please wait: ', pubkey.toBase58());
        const sig = yield node_1.Node.getConnection().requestAirdrop(pubkey, amount);
        yield transaction_1.Transaction.confirmedSig(sig);
    });
    Wallet.create = () => __awaiter(this, void 0, void 0, function* () {
        const keypair = web3_js_1.Keypair.generate();
        if (process.env.NODE_ENV !== constants_1.Constants.ENV.prd) {
            yield Wallet.requestAirdrop(keypair.publicKey);
        }
        return {
