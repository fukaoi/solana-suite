...
((DasApi4) => {
  ...
  DasApi4.findByMint = async (mint, isCompressed) => {
    const asset = await DasApi2.getAsset(mint);
    if (asset.isErr) {
      throw asset.error;
    }
  ...
  DasApi4.findByOwner = async (owner, isCompressed, options = {}) => {
    ...
    const assets = await DasApi2.getAssetsByOwner(
      owner,
      limit,
      page,
      sortBy,
  ...
  DasApi4.findByCollection = async (collectionMint, isCompressed, options = {}) => {
    ...
    const assets = await DasApi2.getAssetsByGroup(
      "collection",
      collectionMint,
      limit,
      page,
