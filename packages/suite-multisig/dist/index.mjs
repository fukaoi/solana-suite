...
((Multisig5) => {
  Multisig5.create = async (m, feePayer, signerPubkeys) => {
    return Try(async () => {
      ...
      const account = Keypair5.generate();
