...
((Multisig5) => {
  Multisig5.getInfo = async (multisig) => {
    return Try(async () => {
      const info = await Node3.getConnection().getAccountInfo(
