...
((Multisig5) => {
  Multisig5.create = async (m, feePayer, signerPubkeys) => {
    return Try(async () => {
      ...
      const account = import_web313.Keypair.generate();
...
((MultisigInstruction2) => {
  ...
  MultisigInstruction2.account = (newAccount, feePayer, balanceNeeded) => {
    return import_web313.SystemProgram.createAccount({
  ...
  MultisigInstruction2.multisig = (m, feePayer, signerPubkey) => {
    const keys = [
      ...
      {
        pubkey: import_web313.SYSVAR_RENT_PUBKEY,
        isSigner: false,
        isWritable: false
      }
    ];
...
((Multisig5) => {
  Multisig5.getInfo = async (multisig) => {
    return Try(async () => {
      ...
      multisigInfo.signer1 = new import_web314.PublicKey(multisigInfo.signer1);
      multisigInfo.signer2 = new import_web314.PublicKey(multisigInfo.signer2);
      multisigInfo.signer3 = new import_web314.PublicKey(multisigInfo.signer3);
      multisigInfo.signer4 = new import_web314.PublicKey(multisigInfo.signer4);
      multisigInfo.signer5 = new import_web314.PublicKey(multisigInfo.signer5);
      multisigInfo.signer6 = new import_web314.PublicKey(multisigInfo.signer6);
      multisigInfo.signer7 = new import_web314.PublicKey(multisigInfo.signer7);
      multisigInfo.signer8 = new import_web314.PublicKey(multisigInfo.signer8);
      multisigInfo.signer9 = new import_web314.PublicKey(multisigInfo.signer9);
      multisigInfo.signer10 = new import_web314.PublicKey(multisigInfo.signer10);
      multisigInfo.signer11 = new import_web314.PublicKey(multisigInfo.signer11);
      return multisigInfo;
    });
  };
})(Multisig2 || (Multisig2 = {}));
