...
declare const Metaplex: {
    ...
    findByOwner: (owner: _solana_suite_shared.Pubkey, onOk: _solana_suite_core.OnOk<shared_metaplex.UserSideOutput.TokenMetadata>, onErr: _solana_suite_core.OnErr, options?: {
        sortable?: _solana_suite_core.Sortable | undefined;
        isHolder?: boolean | undefined;
    } | undefined) => Promise<void>;
    findByMint: (mint: _solana_suite_shared.Pubkey) => Promise<_solana_suite_shared.Result<shared_metaplex.UserSideOutput.NftMetadata, Error>>;
