...
declare const Metaplex: {
    ...
    mint: (owner: _solana_suite_shared.Pubkey, signer: _solana_suite_shared.Secret, input: UserSideInput.NftMetadata, feePayer?: _solana_suite_shared.Secret | undefined, freezeAuthority?: _solana_suite_shared.Pubkey | undefined) => Promise<_solana_suite_shared.Result<_solana_suite_shared.MintInstruction, Error>>;
    ...
    findByOwner: (owner: _solana_suite_shared.Pubkey, onOk: _solana_suite_core.OnOk<types_converter.UserSideOutput.TokenMetadata>, onErr: _solana_suite_core.OnErr, options?: {
        sortable?: _solana_suite_core.Sortable | undefined;
        isHolder?: boolean | undefined;
    } | undefined) => Promise<void>;
    findByMint: (mint: _solana_suite_shared.Pubkey) => Promise<_solana_suite_shared.Result<types_converter.UserSideOutput.NftMetadata, Error>>;
