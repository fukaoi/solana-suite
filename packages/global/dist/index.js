...
((TransactionBuilder8) => {
  ...
  ((PriorityFee2) => {
    ...
    PriorityFee2.createPriorityFeeInstruction = async (transaction) => {
      ...
      debugLog("# estimates: ", estimates);
      const lamports = estimates.isOk ? estimates.unwrap().medium : MINIMUM_PRIORITY_FEE;
      return import_web32.ComputeBudgetProgram.setComputeUnitPrice({
        microLamports: lamports
      });
    };
    const sendTransactionWithPriorityFee = async (lamports, transaction, finalSigners) => {
      const computePriceInst = import_web32.ComputeBudgetProgram.setComputeUnitPrice({
        microLamports: lamports
      });
  ...
  class PartialSign {
    ...
    submit = async (options = {}) => {
      return Try(async () => {
        ...
        const transaction = import_web36.Transaction.from(decode);
...
((Node2) => {
  ...
  Node2.getConnection = () => {
    ...
    return new import_web37.Connection(setted.clusterUrl, setted.commitment);
  };
