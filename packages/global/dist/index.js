...
((TransactionBuilder8) => {
  ...
  ((PriorityFee2) => {
    ...
    PriorityFee2.submit = async (transaction, signers, addSolPriorityFee) => {
      ...
      const computePriceInst = import_web33.ComputeBudgetProgram.setComputeUnitPrice({
    ...
    PriorityFee2.createPriorityFeeInstruction = async (transaction) => {
      ...
      return import_web33.ComputeBudgetProgram.setComputeUnitPrice({
  ...
  class PartialSign {
    ...
    submit = async (options = {}) => {
      return Try(async () => {
        ...
        const transaction = import_web37.Transaction.from(decode);
        if (options.isPriorityFee) {
