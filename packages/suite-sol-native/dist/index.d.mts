...
declare const SolNative: {
    transferWithMultisig: (owner: Pubkey, dest: Pubkey, signers: Secret$1[], amount: number, options?: Partial<AuthorityOptions>) => Promise<Result<Transaction, Error>>;
    transfer: (source: Pubkey, dest: Pubkey, signers: Secret$1[], amount: number, options?: Partial<AuthorityOptions>) => Result<Transaction, Error>;
    gasLessTransfer: (owner: Pubkey, dest: Pubkey, signers: Secret$1[], amount: number, feePayer: Pubkey) => Promise<Result<PartialSignTransaction, Error>>;
