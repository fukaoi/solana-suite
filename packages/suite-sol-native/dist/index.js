...
((SolNative7) => {
  ...
  SolNative7.transferWithMultisig = async (owner, dest, signers, amount, feePayer) => {
    return Try(async () => {
      ...
      const wrapped = await (0, import_spl_token3.createWrappedNativeAccount)(
        connection,
        payer.toKeypair(),
        owner.toPublicKey(),
      ...
      const token = await (0, import_spl_token3.createMint)(
        connection,
        payer.toKeypair(),
        owner.toPublicKey(),
        owner.toPublicKey(),
      ...
      const inst1 = (0, import_spl_token3.createTransferInstruction)(
      ...
      const inst2 = (0, import_spl_token3.createCloseAccountInstruction)(
        wrapped,
        dest.toPublicKey(),
        owner.toPublicKey(),
        keypairs
