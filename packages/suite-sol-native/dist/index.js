...
((SolNative6) => {
  const RADIX = 10;
  SolNative6.gasLessTransfer = async (owner, dest, ownerOrMultisigi, amount, feePayer) => {
    return Try(async () => {
      const blockHashObj = await Node.getConnection().getLatestBlockhash();
