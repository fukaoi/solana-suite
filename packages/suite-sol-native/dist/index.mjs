...
((Converter14) => {
  ...
  })(NftMetadata = Converter14.NftMetadata || (Converter14.NftMetadata = {}));
        ...
        switch (filterType) {
          case "memo" /* Memo */: {
            if (FilterOptions.Memo.program.includes(instruction.program)) {
              ...
              history = Converter13.Memo.intoUserSide(
                instruction,
                txMeta,
                instructionTransfer,
                postTokenAccount
          ...
          case "mint" /* Mint */: {
            if (FilterOptions.Mint.program.includes(instruction.program) && FilterOptions.Mint.action.includes(
              ...
              history = Converter13.Mint.intoUserSide(instruction, txMeta);
            }
            break;
          }
          case "transfer" /* Transfer */:
            if (moduleName === instruction.program && FilterOptions.Transfer.action.includes(
              ...
              if (instruction.parsed.type === "transferChecked") {
                history = Converter13.TransferChecked.intoUserSide(
                  instruction,
                  txMeta,
                  postTokenAccount
                );
              } else {
                history = Converter13.Transfer.intoUserSide(
                  instruction,
                  txMeta
                );
              }
