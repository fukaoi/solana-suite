...
((SolNative6) => {
  const RADIX = 10;
  SolNative6.transfer = (source, dest, ownerOrMultisig, amount, options = {}) => {
    return Try(() => {
...
((SolNative6) => {
  const RADIX = 10;
  SolNative6.transferWithMultisig = async (owner, dest, ownerOrMultisig, amount, options = {}) => {
    return Try(async () => {
