...
((SolNative6) => {
  SolNative6.findByOwner = async (owner) => {
    return Try(async () => {
      const res = await Node3.getConnection().getParsedAccountInfo(
        owner.toPublicKey()
      );
      const info = {
        sol: 0,
