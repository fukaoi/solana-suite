...
// src/find.ts
import { SplToken as SplToken2 } from "@solana-suite/spl-token";
var TraditionalNft2;
((TraditionalNft10) => {
...
((TraditionalNft10) => {
  TraditionalNft10.feePayerPartialSignMint = async (owner, signer, input, feePayer, freezeAuthority) => {
    return Try(async () => {
      ...
      const sellerFeeBasisPoints = Converter12.Royalty.intoInfraSide(input.royalty);
      let uri = "";
...
import { SplToken as SplToken3 } from "@solana-suite/spl-token";
var TraditionalNft6;
((TraditionalNft10) => {
  const NFT_AMOUNT2 = 1;
  const NFT_DECIMALS = 0;
...
// src/transfer.ts
import { SplToken as SplToken4 } from "@solana-suite/spl-token";
var TraditionalNft8;
((TraditionalNft10) => {
  const NFT_AMOUNT2 = 1;
  const NFT_DECIMALS = 0;
  TraditionalNft10.transfer = (mint, owner, dest, signers, feePayer) => {
