    ...
    submit = async (options = {}) => {
      return Try(async () => {
        ...
        if (options.isPriorityFee) {
          return await TransactionBuilder2.PriorityFee.submit(
            transaction,
            finalSigners,
  ...
  class PartialSign {
    ...
    submit = async (options = {}) => {
      return Try(async () => {
        ...
        if (options.isPriorityFee) {
          return await TransactionBuilder2.PriorityFee.submitForPartialSign(
            transaction,
