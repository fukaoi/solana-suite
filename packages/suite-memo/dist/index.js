...
((Memo4) => {
  ...
  Memo4.create = (data, owner, options = {}) => {
    return Try(() => {
      ...
      const instruction = new import_web313.TransactionInstruction({
