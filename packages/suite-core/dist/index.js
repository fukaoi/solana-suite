...
var Constants2;
((Constants24) => {
  Constants24.currentCluster = import_config2.default.cluster.type;
  Constants24.customClusterUrl = import_config2.default.cluster.customClusterUrl;
  Constants24.isDebugging = import_config2.default.debugging;
  Constants24.nftStorageApiKey = import_config2.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants24.WRAPPED_TOKEN_PROGRAM_ID = new import_web32.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants24.MEMO_PROGRAM_ID = new import_web32.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants24.METAPLEX_PROGRAM_ID = new import_web32.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants24.COMMITMENT = "confirmed";
  Constants24.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants24.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants24.BUNDLR_NETWORK_URL = (0, Constants24.switchBundlr)(import_config2.default.cluster.type);
...
((Multisig6) => {
  ...
  Multisig6.account = (newAccount, feePayer, balanceNeeded) => {
    return import_web35.SystemProgram.createAccount({
  ...
  Multisig6.multisig = (m, feePayer, signerPubkey) => {
    const keys = [
      ...
      {
        pubkey: import_web35.SYSVAR_RENT_PUBKEY,
        isSigner: false,
        isWritable: false
      }
    ];
...
((Multisig6) => {
  Multisig6.create = async (m, feePayer, signerPubkeys) => {
    return Try(async () => {
      ...
      const account = import_web36.Keypair.generate();
      ...
      return new import_instruction3.Instruction(
        [inst1, inst2],
        [account],
        feePayer.toKeypair(),
...
((Multisig6) => {
  Multisig6.getInfo = async (multisig) => {
    return Try(async () => {
      ...
      multisigInfo.signer1 = new import_web37.PublicKey(multisigInfo.signer1);
      multisigInfo.signer2 = new import_web37.PublicKey(multisigInfo.signer2);
      multisigInfo.signer3 = new import_web37.PublicKey(multisigInfo.signer3);
      multisigInfo.signer4 = new import_web37.PublicKey(multisigInfo.signer4);
      multisigInfo.signer5 = new import_web37.PublicKey(multisigInfo.signer5);
      multisigInfo.signer6 = new import_web37.PublicKey(multisigInfo.signer6);
      multisigInfo.signer7 = new import_web37.PublicKey(multisigInfo.signer7);
      multisigInfo.signer8 = new import_web37.PublicKey(multisigInfo.signer8);
      multisigInfo.signer9 = new import_web37.PublicKey(multisigInfo.signer9);
      multisigInfo.signer10 = new import_web37.PublicKey(multisigInfo.signer10);
      multisigInfo.signer11 = new import_web37.PublicKey(multisigInfo.signer11);
      return multisigInfo;
    });
  };
})(Multisig3 || (Multisig3 = {}));
...
((SolNative7) => {
  ...
  SolNative7.feePayerPartialSignTransfer = async (owner, dest, signers, amount, feePayer) => {
    return Try(async () => {
      ...
      return new import_instruction5.PartialSignInstruction(hex);
    });
  };
...
var import_instruction8 = require("instruction");
...
var import_instruction7 = require("instruction");
...
((Constants222) => {
  ...
  Constants222.WRAPPED_TOKEN_PROGRAM_ID = new import_web310.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants222.MEMO_PROGRAM_ID = new import_web310.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants222.METAPLEX_PROGRAM_ID = new import_web310.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
...
var Constants22;
((Constants222) => {
  Constants222.currentCluster = import_config4.default.cluster.type;
  Constants222.customClusterUrl = import_config4.default.cluster.customClusterUrl;
  Constants222.isDebugging = import_config4.default.debugging;
  Constants222.nftStorageApiKey = import_config4.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants222.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants222.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants222.BUNDLR_NETWORK_URL = (0, Constants222.switchBundlr)(import_config4.default.cluster.type);
...
var KeypairAccount = class _KeypairAccount {
  ...
  toPublicKey() {
    return new import_web313.PublicKey(this.pubkey);
  }
  toKeypair() {
  ...
  static create = () => {
    const keypair = import_web313.Keypair.generate();
...
((AssociatedAccount2) => {
  ...
  const get = async (mint, owner, feePayer, allowOwnerOffCurve = false) => {
    ...
    return new import_instruction7.Instruction(
      [res.inst],
      [],
      feePayer.toKeypair(),
      res.tokenAccount
    ...
    while (counter < RETRY_OVER_LIMIT) {
      try {
        ...
        if (inst && typeof inst === "string") {
          ...
          return inst;
        } else if (inst instanceof import_instruction7.Instruction) {
...
((Pda2) => {
  Pda2.getMetadata = (mint) => {
    const [publicKey] = import_web314.PublicKey.findProgramAddressSync(
      [
...
((SolNative7) => {
  ...
  SolNative7.transferWithMultisig = async (owner, dest, signers, amount, feePayer) => {
    return Try(async () => {
      ...
      return new import_instruction8.Instruction(
        [inst1, inst2],
        signers.map((s) => s.toKeypair()),
        feePayer?.toKeypair()
      );
...
var import_instruction9 = require("instruction");
...
((SplToken12) => {
  SplToken12.add = async (token, owner, signers, totalAmount, mintDecimal, feePayer) => {
    return Try(async () => {
      ...
      return new import_instruction9.Instruction([inst], keypairs, payer.toKeypair(), token);
    });
  };
})(SplToken2 || (SplToken2 = {}));
...
var import_instruction10 = require("instruction");
var SplToken3;
((SplToken12) => {
  SplToken12.burn = (mint, owner, signers, burnAmount, tokenDecimals, feePayer) => {
    return Try(() => {
      ...
      return new import_instruction10.Instruction([inst], keypairs, payer);
    });
  };
})(SplToken3 || (SplToken3 = {}));
...
((Constants24) => {
  ...
  Constants24.WRAPPED_TOKEN_PROGRAM_ID = new import_web315.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants24.MEMO_PROGRAM_ID = new import_web315.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants24.METAPLEX_PROGRAM_ID = new import_web315.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants24.COMMITMENT = "confirmed";
  Constants24.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
...
var import_instruction11 = require("instruction");
...
((SplToken12) => {
  SplToken12.freeze = (mint, owner, freezeAuthority, feePayer) => {
    ...
    return Try(() => {
      ...
      return new import_instruction11.Instruction(
        [inst],
...
var import_instruction12 = require("instruction");
var SplToken6;
((SplToken12) => {
  SplToken12.feePayerPartialSignTransfer = async (mint, owner, dest, signers, amount, mintDecimal, feePayer) => {
    return Try(async () => {
      ...
      const hex = serializedTx.toString("hex");
      return new import_instruction12.PartialSignInstruction(hex);
    });
  };
})(SplToken6 || (SplToken6 = {}));
...
var import_instruction13 = require("instruction");
...
var Constants5;
((Constants222) => {
  Constants222.currentCluster = import_config6.default.cluster.type;
  Constants222.customClusterUrl = import_config6.default.cluster.customClusterUrl;
  Constants222.isDebugging = import_config6.default.debugging;
  Constants222.nftStorageApiKey = import_config6.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants222.WRAPPED_TOKEN_PROGRAM_ID = new import_web317.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants222.MEMO_PROGRAM_ID = new import_web317.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants222.METAPLEX_PROGRAM_ID = new import_web317.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants222.COMMITMENT = "confirmed";
  Constants222.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants222.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants222.BUNDLR_NETWORK_URL = (0, Constants222.switchBundlr)(import_config6.default.cluster.type);
...
((Constants222) => {
  ...
  Constants222.WRAPPED_TOKEN_PROGRAM_ID = new import_web318.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants222.MEMO_PROGRAM_ID = new import_web318.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants222.METAPLEX_PROGRAM_ID = new import_web318.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants222.COMMITMENT = "confirmed";
  Constants222.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
...
var Constants6;
((Constants24) => {
  Constants24.currentCluster = import_config8.default.cluster.type;
  Constants24.customClusterUrl = import_config8.default.cluster.customClusterUrl;
  Constants24.isDebugging = import_config8.default.debugging;
  Constants24.nftStorageApiKey = import_config8.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants24.WRAPPED_TOKEN_PROGRAM_ID = new import_web319.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants24.MEMO_PROGRAM_ID = new import_web319.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants24.METAPLEX_PROGRAM_ID = new import_web319.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants24.COMMITMENT = "confirmed";
  Constants24.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants24.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants24.BUNDLR_NETWORK_URL = (0, Constants24.switchBundlr)(import_config8.default.cluster.type);
...
((SplToken12) => {
  ...
  SplToken12.createMintInstructions = async (mint2, owner, totalAmount, mintDecimal, tokenMetadata, feePayer, isMutable) => {
    ...
    const inst1 = import_web320.SystemProgram.createAccount({
      fromPubkey: feePayer,
  ...
  SplToken12.mint = async (owner, signer, totalAmount, mintDecimal, input, feePayer, freezeAuthority) => {
    return Try(async () => {
      ...
      return new import_instruction13.MintInstruction(
        insts,
...
var import_instruction14 = require("instruction");
...
((SplToken12) => {
  SplToken12.thaw = (mint, owner, freezeAuthority, feePayer) => {
    ...
    return Try(() => {
      ...
      return new import_instruction14.Instruction(
        [inst],
        [freezeAuthority.toKeypair()],
        payer.toKeypair()
      );
...
var import_instruction15 = require("instruction");
var SplToken10;
((SplToken12) => {
  SplToken12.transfer = async (mint, owner, dest, signers, amount, mintDecimal, feePayer) => {
    return Try(async () => {
      ...
      return new import_instruction15.Instruction([inst], keypairs, payer.toKeypair());
    });
  };
