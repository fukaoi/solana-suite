...
var Constants;
((Constants8) => {
  Constants8.currentCluster = import_config.default.cluster.type;
  Constants8.customClusterUrl = import_config.default.cluster.customClusterUrl;
  Constants8.isDebugging = import_config.default.debugging;
  Constants8.nftStorageApiKey = import_config.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
  ...
  Constants8.WRAPPED_TOKEN_PROGRAM_ID = new import_web3.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants8.MEMO_PROGRAM_ID = new import_web3.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants8.METAPLEX_PROGRAM_ID = new import_web3.PublicKey(
  ...
  Constants8.BUNDLR_NETWORK_URL = (0, Constants8.switchBundlr)(import_config.default.cluster.type);
})(Constants || (Constants = {}));
...
var Constants2;
((Constants25) => {
  Constants25.currentCluster = import_config2.default.cluster.type;
  Constants25.customClusterUrl = import_config2.default.cluster.customClusterUrl;
  Constants25.isDebugging = import_config2.default.debugging;
  Constants25.nftStorageApiKey = import_config2.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants25.WRAPPED_TOKEN_PROGRAM_ID = new import_web32.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants25.MEMO_PROGRAM_ID = new import_web32.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants25.METAPLEX_PROGRAM_ID = new import_web32.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  ...
  Constants25.BUNDLR_NETWORK_URL = (0, Constants25.switchBundlr)(import_config2.default.cluster.type);
...
((Memo4) => {
  ...
  Memo4.create = (data, owner, signer, feePayer) => {
    ...
    const instruction = new import_web38.TransactionInstruction({
...
((Multisig6) => {
  ...
  Multisig6.account = (newAccount, feePayer, balanceNeeded) => {
    return import_web39.SystemProgram.createAccount({
  ...
  Multisig6.multisig = (m, feePayer, signerPubkey) => {
    const keys = [
      ...
      {
        pubkey: import_web39.SYSVAR_RENT_PUBKEY,
        isSigner: false,
        isWritable: false
      }
    ];
...
((Multisig6) => {
  Multisig6.getInfo = async (multisig) => {
    return Try(async () => {
      ...
      if (!info.owner.equals(import_spl_token2.TOKEN_PROGRAM_ID)) {
...
((SolNative7) => {
  ...
  SolNative7.transfer = (source, dest, signers, amount, feePayer) => {
    return Try(() => {
      const inst = import_web313.SystemProgram.transfer({
...
var Constants3;
((Constants232) => {
  Constants232.currentCluster = import_config3.default.cluster.type;
  Constants232.customClusterUrl = import_config3.default.cluster.customClusterUrl;
  Constants232.isDebugging = import_config3.default.debugging;
  Constants232.nftStorageApiKey = import_config3.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants232.WRAPPED_TOKEN_PROGRAM_ID = new import_web314.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants232.MEMO_PROGRAM_ID = new import_web314.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants232.METAPLEX_PROGRAM_ID = new import_web314.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  ...
  Constants232.BUNDLR_NETWORK_URL = (0, Constants232.switchBundlr)(import_config3.default.cluster.type);
...
var Constants22;
((Constants232) => {
  Constants232.currentCluster = import_config4.default.cluster.type;
  Constants232.customClusterUrl = import_config4.default.cluster.customClusterUrl;
  Constants232.isDebugging = import_config4.default.debugging;
  Constants232.nftStorageApiKey = import_config4.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants232.WRAPPED_TOKEN_PROGRAM_ID = new import_web315.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants232.MEMO_PROGRAM_ID = new import_web315.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants232.METAPLEX_PROGRAM_ID = new import_web315.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants232.COMMITMENT = "confirmed";
  Constants232.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants232.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants232.BUNDLR_NETWORK_URL = (0, Constants232.switchBundlr)(import_config4.default.cluster.type);
...
((Node223) => {
  ...
  Node223.getConnection = () => {
    ...
    return new import_web316.Connection(setted.clusterUrl, setted.commitment);
  };
...
var Constants32;
((Constants2223) => {
  Constants2223.currentCluster = import_config5.default.cluster.type;
  Constants2223.customClusterUrl = import_config5.default.cluster.customClusterUrl;
  Constants2223.isDebugging = import_config5.default.debugging;
  Constants2223.nftStorageApiKey = import_config5.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants2223.WRAPPED_TOKEN_PROGRAM_ID = new import_web318.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants2223.MEMO_PROGRAM_ID = new import_web318.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants2223.METAPLEX_PROGRAM_ID = new import_web318.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  ...
  Constants2223.BUNDLR_NETWORK_URL = (0, Constants2223.switchBundlr)(import_config5.default.cluster.type);
...
((Node223) => {
  ...
  Node223.getConnection = () => {
    ...
    return new import_web319.Connection(setted.clusterUrl, setted.commitment);
  };
  Node223.changeConnection = (param) => {
    setted.clusterUrl = "";
    setted.customClusterUrl = [];
...
var Constants222;
((Constants2223) => {
  Constants2223.currentCluster = import_config6.default.cluster.type;
  Constants2223.customClusterUrl = import_config6.default.cluster.customClusterUrl;
  Constants2223.isDebugging = import_config6.default.debugging;
  Constants2223.nftStorageApiKey = import_config6.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants2223.WRAPPED_TOKEN_PROGRAM_ID = new import_web320.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants2223.MEMO_PROGRAM_ID = new import_web320.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants2223.METAPLEX_PROGRAM_ID = new import_web320.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants2223.COMMITMENT = "confirmed";
  Constants2223.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants2223.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants2223.BUNDLR_NETWORK_URL = (0, Constants2223.switchBundlr)(import_config6.default.cluster.type);
...
var Instruction3 = class {
  static batchSubmit = async (arr) => {
    ...
    const transaction = new import_web321.Transaction();
    let finalSigners = signers;
    if (feePayer) {
      transaction.feePayer = feePayer.publicKey;
      finalSigners = [feePayer, ...signers];
    ...
    return await (0, import_web321.sendAndConfirmTransaction)(
...
var Instruction22 = class _Instruction {
  ...
  submit = async () => {
    return Try2(async () => {
      ...
      return await (0, import_web317.sendAndConfirmTransaction)(
        Node22.getConnection(),
        transaction,
        finalSigners,
        options
...
var KeypairAccount = class _KeypairAccount {
  ...
  toPublicKey() {
    return new import_web324.PublicKey(this.pubkey);
  }
  toKeypair() {
    const decoded = import_bs582.default.decode(this.secret);
    return import_web324.Keypair.fromSecretKey(decoded);
  }
  static isPubkey = (value) => /^[0-9a-zA-Z]{32,44}$/.test(value);
  static isSecret = (value) => /^[0-9a-zA-Z]{87,88}$/.test(value);
  static create = () => {
    const keypair = import_web324.Keypair.generate();
...
((Pda22) => {
  Pda22.getMetadata = (mint) => {
    const [publicKey] = import_web325.PublicKey.findProgramAddressSync(
      [
...
var import_config7 = __toESM(require("@solana-suite/config"), 1);
var Converter;
((Converter92) => {
  let Collection;
  ((Collection2) => {
...
var Constants4;
((Constants25) => {
  Constants25.currentCluster = import_config7.default.cluster.type;
  Constants25.customClusterUrl = import_config7.default.cluster.customClusterUrl;
  Constants25.isDebugging = import_config7.default.debugging;
  Constants25.nftStorageApiKey = import_config7.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants25.WRAPPED_TOKEN_PROGRAM_ID = new import_web326.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants25.MEMO_PROGRAM_ID = new import_web326.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants25.METAPLEX_PROGRAM_ID = new import_web326.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants25.COMMITMENT = "confirmed";
  Constants25.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants25.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants25.BUNDLR_NETWORK_URL = (0, Constants25.switchBundlr)(import_config7.default.cluster.type);
...
((SplToken11) => {
  SplToken11.feePayerPartialSignTransfer = async (mint, owner, dest, signers, amount, mintDecimal, feePayer) => {
    return Try(async () => {
      ...
      let inst2;
      const blockhashObj = await Node.getConnection().getLatestBlockhash();
      const tx = new import_web327.Transaction({
        lastValidBlockHeight: blockhashObj.lastValidBlockHeight,
        blockhash: blockhashObj.blockhash,
        feePayer: feePayer.toPublicKey()
      });
      if (!destToken.inst) {
        inst2 = (0, import_spl_token8.createTransferCheckedInstruction)(
...
var import_config8 = __toESM(require("@solana-suite/config"), 1);
var import_web329 = require("@solana/web3.js");
var import_config9 = __toESM(require("@solana-suite/config"), 1);
var Constants5;
((Constants224) => {
  Constants224.currentCluster = import_config8.default.cluster.type;
  Constants224.customClusterUrl = import_config8.default.cluster.customClusterUrl;
  Constants224.isDebugging = import_config8.default.debugging;
  Constants224.nftStorageApiKey = import_config8.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants224.WRAPPED_TOKEN_PROGRAM_ID = new import_web328.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants224.MEMO_PROGRAM_ID = new import_web328.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants224.METAPLEX_PROGRAM_ID = new import_web328.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  ...
  Constants224.BUNDLR_NETWORK_URL = (0, Constants224.switchBundlr)(import_config8.default.cluster.type);
...
var Constants23;
((Constants224) => {
  Constants224.currentCluster = import_config9.default.cluster.type;
  Constants224.customClusterUrl = import_config9.default.cluster.customClusterUrl;
  Constants224.isDebugging = import_config9.default.debugging;
  Constants224.nftStorageApiKey = import_config9.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants224.WRAPPED_TOKEN_PROGRAM_ID = new import_web329.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants224.MEMO_PROGRAM_ID = new import_web329.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants224.METAPLEX_PROGRAM_ID = new import_web329.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants224.COMMITMENT = "confirmed";
  Constants224.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants224.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants224.BUNDLR_NETWORK_URL = (0, Constants224.switchBundlr)(import_config9.default.cluster.type);
...
var import_config10 = __toESM(require("@solana-suite/config"), 1);
var Constants6;
((Constants25) => {
  Constants25.currentCluster = import_config10.default.cluster.type;
  Constants25.customClusterUrl = import_config10.default.cluster.customClusterUrl;
  Constants25.isDebugging = import_config10.default.debugging;
  Constants25.nftStorageApiKey = import_config10.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants25.WRAPPED_TOKEN_PROGRAM_ID = new import_web330.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants25.MEMO_PROGRAM_ID = new import_web330.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants25.METAPLEX_PROGRAM_ID = new import_web330.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants25.COMMITMENT = "confirmed";
  Constants25.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants25.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants25.BUNDLR_NETWORK_URL = (0, Constants25.switchBundlr)(import_config10.default.cluster.type);
...
((SplToken11) => {
  SplToken11.createFreezeAuthority = (mint2, owner, freezeAuthority) => {
    return (0, import_spl_token10.createSetAuthorityInstruction)(
      mint2,
      owner,
      import_spl_token10.AuthorityType.FreezeAccount,
      freezeAuthority
    );
  };
  SplToken11.createMintInstructions = async (mint2, owner, totalAmount, mintDecimal, tokenMetadata, feePayer, isMutable) => {
    const connection = Node.getConnection();
    const lamports = await (0, import_spl_token10.getMinimumBalanceForRentExemptMint)(connection);
    const metadataPda = Pda.getMetadata(mint2.toString());
    const tokenAssociated = (0, import_spl_token10.getAssociatedTokenAddressSync)(mint2, owner);
    const inst1 = import_web331.SystemProgram.createAccount({
      fromPubkey: feePayer,
      newAccountPubkey: mint2,
      space: import_spl_token10.MINT_SIZE,
      lamports,
      programId: import_spl_token10.TOKEN_PROGRAM_ID
    });
    const inst2 = (0, import_spl_token10.createInitializeMintInstruction)(
      mint2,
      mintDecimal,
      owner,
      owner,
      import_spl_token10.TOKEN_PROGRAM_ID
    );
    const inst3 = (0, import_spl_token10.createAssociatedTokenAccountInstruction)(
      feePayer,
      tokenAssociated,
      owner,
      mint2
    );
    const inst4 = (0, import_spl_token10.createMintToCheckedInstruction)(
      mint2,
      tokenAssociated,
      owner,
      SplToken.calculateAmount(totalAmount, mintDecimal),
...
((SplToken11) => {
  SplToken11.thaw = (mint, owner, freezeAuthority, feePayer) => {
    ...
    return Try(() => {
      const tokenAccount = (0, import_spl_token11.getAssociatedTokenAddressSync)(
        mint.toPublicKey(),
        owner.toPublicKey()
      );
      const inst = (0, import_spl_token11.createThawAccountInstruction)(
        tokenAccount,
        mint.toPublicKey(),
...
((SplToken11) => {
  SplToken11.transfer = async (mint, owner, dest, signers, amount, mintDecimal, feePayer) => {
    return Try(async () => {
      ...
      const inst = (0, import_spl_token12.createTransferCheckedInstruction)(
        sourceToken.toPublicKey(),
        mint.toPublicKey(),
        destToken.toPublicKey(),
        owner.toPublicKey(),
...
var Constants7;
((Constants232) => {
  Constants232.currentCluster = import_config11.default.cluster.type;
  Constants232.customClusterUrl = import_config11.default.cluster.customClusterUrl;
  Constants232.isDebugging = import_config11.default.debugging;
  Constants232.nftStorageApiKey = import_config11.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants232.WRAPPED_TOKEN_PROGRAM_ID = new import_web333.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants232.MEMO_PROGRAM_ID = new import_web333.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants232.METAPLEX_PROGRAM_ID = new import_web333.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants232.COMMITMENT = "confirmed";
  Constants232.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants232.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants232.BUNDLR_NETWORK_URL = (0, Constants232.switchBundlr)(import_config11.default.cluster.type);
...
((Node232) => {
  ...
  Node232.getConnection = () => {
    ...
    return new import_web334.Connection(setted.clusterUrl, setted.commitment);
  };
...
var Constants24;
((Constants232) => {
  Constants232.currentCluster = import_config12.default.cluster.type;
  Constants232.customClusterUrl = import_config12.default.cluster.customClusterUrl;
  Constants232.isDebugging = import_config12.default.debugging;
  Constants232.nftStorageApiKey = import_config12.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants232.WRAPPED_TOKEN_PROGRAM_ID = new import_web335.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants232.MEMO_PROGRAM_ID = new import_web335.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants232.METAPLEX_PROGRAM_ID = new import_web335.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants232.COMMITMENT = "confirmed";
  Constants232.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants232.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants232.BUNDLR_NETWORK_URL = (0, Constants232.switchBundlr)(import_config12.default.cluster.type);
...
var Constants33;
((Constants232) => {
  Constants232.currentCluster = import_config13.default.cluster.type;
  Constants232.customClusterUrl = import_config13.default.cluster.customClusterUrl;
  Constants232.isDebugging = import_config13.default.debugging;
  Constants232.nftStorageApiKey = import_config13.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants232.WRAPPED_TOKEN_PROGRAM_ID = new import_web336.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants232.MEMO_PROGRAM_ID = new import_web336.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants232.METAPLEX_PROGRAM_ID = new import_web336.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants232.COMMITMENT = "confirmed";
  Constants232.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants232.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants232.BUNDLR_NETWORK_URL = (0, Constants232.switchBundlr)(import_config13.default.cluster.type);
...
var Constants223;
((Constants232) => {
  Constants232.currentCluster = import_config14.default.cluster.type;
  Constants232.customClusterUrl = import_config14.default.cluster.customClusterUrl;
  Constants232.isDebugging = import_config14.default.debugging;
  Constants232.nftStorageApiKey = import_config14.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants232.WRAPPED_TOKEN_PROGRAM_ID = new import_web337.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants232.MEMO_PROGRAM_ID = new import_web337.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants232.METAPLEX_PROGRAM_ID = new import_web337.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants232.COMMITMENT = "confirmed";
  Constants232.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants232.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants232.BUNDLR_NETWORK_URL = (0, Constants232.switchBundlr)(import_config14.default.cluster.type);
...
((Node2222) => {
  ...
  Node2222.getConnection = () => {
    ...
    return new import_web338.Connection(setted.clusterUrl, setted.commitment);
  };
...
var Constants322;
((Constants22222) => {
  Constants22222.currentCluster = import_config15.default.cluster.type;
  Constants22222.customClusterUrl = import_config15.default.cluster.customClusterUrl;
  Constants22222.isDebugging = import_config15.default.debugging;
  Constants22222.nftStorageApiKey = import_config15.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants22222.WRAPPED_TOKEN_PROGRAM_ID = new import_web340.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants22222.MEMO_PROGRAM_ID = new import_web340.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants22222.METAPLEX_PROGRAM_ID = new import_web340.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  ...
  Constants22222.BUNDLR_NETWORK_URL = (0, Constants22222.switchBundlr)(import_config15.default.cluster.type);
...
((Node2222) => {
  ...
  Node2222.getConnection = () => {
    ...
    return new import_web341.Connection(setted.clusterUrl, setted.commitment);
  };
  Node2222.changeConnection = (param) => {
    setted.clusterUrl = "";
    setted.customClusterUrl = [];
...
var Constants2222;
((Constants22222) => {
  Constants22222.currentCluster = import_config16.default.cluster.type;
  Constants22222.customClusterUrl = import_config16.default.cluster.customClusterUrl;
  Constants22222.isDebugging = import_config16.default.debugging;
  Constants22222.nftStorageApiKey = import_config16.default.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants22222.WRAPPED_TOKEN_PROGRAM_ID = new import_web342.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants22222.MEMO_PROGRAM_ID = new import_web342.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants22222.METAPLEX_PROGRAM_ID = new import_web342.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants22222.COMMITMENT = "confirmed";
  Constants22222.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants22222.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants22222.BUNDLR_NETWORK_URL = (0, Constants22222.switchBundlr)(import_config16.default.cluster.type);
...
var Instruction4 = class {
  static batchSubmit = async (arr) => {
    ...
    const transaction = new import_web343.Transaction();
    let finalSigners = signers;
    if (feePayer) {
      transaction.feePayer = feePayer.publicKey;
      finalSigners = [feePayer, ...signers];
    ...
    return await (0, import_web343.sendAndConfirmTransaction)(
...
var Instruction23 = class _Instruction2 {
  ...
  submit = async () => {
    return Try5(async () => {
      ...
      const transaction = new import_web339.Transaction();
      ...
      return await (0, import_web339.sendAndConfirmTransaction)(
        Node222.getConnection(),
        transaction,
        finalSigners,
        options
...
var KeypairAccount2 = class _KeypairAccount2 {
  ...
  toPublicKey() {
    return new import_web346.PublicKey(this.pubkey);
  }
  toKeypair() {
    const decoded = import_bs583.default.decode(this.secret);
    return import_web346.Keypair.fromSecretKey(decoded);
  }
  static isPubkey = (value) => /^[0-9a-zA-Z]{32,44}$/.test(value);
  static isSecret = (value) => /^[0-9a-zA-Z]{87,88}$/.test(value);
  static create = () => {
    const keypair = import_web346.Keypair.generate();
...
((AssociatedAccount22) => {
  ...
  AssociatedAccount22.makeOrCreateInstruction = async (mint, owner, feePayer, allowOwnerOffCurve = false) => {
    const associatedTokenAccount = (0, import_spl_token13.getAssociatedTokenAddressSync)(
      mint.toPublicKey(),
      owner.toPublicKey(),
      allowOwnerOffCurve,
      import_spl_token13.TOKEN_PROGRAM_ID,
      import_spl_token13.ASSOCIATED_TOKEN_PROGRAM_ID
    );
    debugLog33("# associatedTokenAccount: ", associatedTokenAccount.toString());
    try {
      await (0, import_spl_token13.getAccount)(
      ...
      if (!(error instanceof import_spl_token13.TokenAccountNotFoundError) && !(error instanceof import_spl_token13.TokenInvalidAccountOwnerError)) {
        throw Error("Unexpected error");
      }
      const payer = !feePayer ? owner : feePayer;
      const inst = (0, import_spl_token13.createAssociatedTokenAccountInstruction)(
        payer.toPublicKey(),
        associatedTokenAccount,
        owner.toPublicKey(),
        mint.toPublicKey(),
...
((Pda22) => {
  Pda22.getMetadata = (mint) => {
    const [publicKey] = import_web347.PublicKey.findProgramAddressSync(
      [
        Buffer.from("metadata"),
        import_mpl_token_metadata4.PROGRAM_ID.toBuffer(),
        mint.toPublicKey().toBuffer()
      ],
      import_mpl_token_metadata4.PROGRAM_ID
    );
    return publicKey;
  };
  Pda22.getMasterEdition = (mint) => {
...
String.prototype.toPublicKey = function() {
  ...
  return new import_web332.PublicKey(this);
};
String.prototype.toKeypair = function() {
  if (!KeypairAccount2.isSecret(this.toString())) {
    throw Error(`No match KeyPair.Secret: ${this.toString()}`);
  }
  const decoded = import_bs584.default.decode(this);
  return import_web332.Keypair.fromSecretKey(decoded);
};
Number.prototype.toSol = function() {
  return (0, import_bignumber.BigNumber)(this).div(import_web332.LAMPORTS_PER_SOL).toNumber();
};
Number.prototype.toLamports = function() {
  return (0, import_bignumber.BigNumber)(this).times(import_web332.LAMPORTS_PER_SOL).toNumber();
};
