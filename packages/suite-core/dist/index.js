...
((SplToken11) => {
  ...
  SplToken11.createMintInstructions = async (mint2, owner, totalAmount, mintDecimal, tokenMetadata, feePayer, isMutable) => {
    ...
    const inst1 = import_web317.SystemProgram.createAccount({
      fromPubkey: feePayer,
