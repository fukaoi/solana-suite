...
export declare namespace SplToken {
    const genericFindByOwner: <T extends unknown>(owner: Pubkey, callback: (result: Result<T[], Error>) => void, tokenStandard: UserSideInput.TokenStandard, sortable?: Sortable, isHolder?: boolean) => Promise<void>;
    const genericFindByMint: <T extends unknown>(mint: Pubkey, tokenStandard: UserSideInput.TokenStandard) => Promise<Result<T, Error>>;
    /**
