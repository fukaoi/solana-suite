...
(function (PhantomSplToken) {
    PhantomSplToken.add = (tokenKey, owner, cluster, totalAmount, mintDecimal, phantom) => __awaiter(this, void 0, void 0, function* () {
        return (0, shared_1.Try)(() => __awaiter(this, void 0, void 0, function* () {
            ...
            transaction.add((0, spl_token_1.createMintToCheckedInstruction)(tokenKey.toPublicKey(), makeInstruction.tokenAccount.toPublicKey(), owner.toPublicKey(), totalAmount, mintDecimal, [], spl_token_1.TOKEN_PROGRAM_ID));
