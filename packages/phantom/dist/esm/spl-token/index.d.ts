export declare const PhantomSplToken: {
    mint: (input: import("@solana-suite/shared-metaplex").UserSideInput.TokenMetadata, owner: import("@solana-suite/shared").Pubkey, cluster: string, totalAmount: number, mintDecimal: number, phantom: import("..").Phantom) => Promise<import("@solana-suite/shared").Result<string, Error>>;
