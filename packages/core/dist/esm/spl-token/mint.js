...
(function (SplToken) {
    SplToken.mint = (owner, signers, totalAmount, mintDecimal, input, feePayer) => __awaiter(this, void 0, void 0, function* () {
        return Try(() => __awaiter(this, void 0, void 0, function* () {
            ...
            const inst3 = createAssociatedTokenAccountInstruction(owner, tokenAssociated, owner, mint.publicKey);
            const inst4 = createMintToInstruction(mint.publicKey, tokenAssociated, owner, _Calculate.calculateAmount(totalAmount, mintDecimal));
