...
export declare const SolNative: {
    ...
    transfer: (source: import("@solana/web3.js").PublicKey, destination: import("@solana/web3.js").PublicKey, signers: import("@solana/web3.js").Keypair[], amount: number, feePayer?: import("@solana/web3.js").Keypair | undefined) => Promise<import("@solana-suite/shared").Result<import("@solana-suite/shared").Instruction, Error>>;
