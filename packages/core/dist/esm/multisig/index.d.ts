export declare const Multisig: {
    ...
    create: (m: number, feePayer: import("@solana-suite/shared").Secret, signerPubkey: import("@solana-suite/shared").Pubkey[]) => Promise<import("@solana-suite/shared").Result<import("@solana-suite/shared").Instruction, Error>>;
};
