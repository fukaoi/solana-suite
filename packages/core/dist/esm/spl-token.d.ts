...
export declare namespace SplToken {
    ...
    const burn: (tokenKey: PublicKey, owner: PublicKey, signers: Signer[], burnAmount: number, tokenDecimals: number, feePayer?: Signer | undefined) => Promise<Result.Ok<Instruction, Error> | Result.Err<Instruction, Error>>;
