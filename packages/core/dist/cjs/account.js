...
(function (Account) {
    ...
    Account.MAX_AIRDROP_SOL = web3_js_1.LAMPORTS_PER_SOL * 2;
    ...
    Account.getBalance = (pubkey, unit = 'sol') => __awaiter(this, void 0, void 0, function* () {
        const balance = yield shared_1.Node.getConnection()
            .getBalance(pubkey)
            .then(shared_1.Result.ok)
            .catch(shared_1.Result.err);
        if (balance.isErr) {
        ...
        switch (unit) {
            case 'sol':
                return shared_1.Result.ok(balance.value / web3_js_1.LAMPORTS_PER_SOL);
            case 'lamports':
                return balance;
            default:
                return shared_1.Result.err(Error('no match unit'));
        }
    });
    // @todo: SplToken
    Account.getTokenBalance = (pubkey, mint) => __awaiter(this, void 0, void 0, function* () {
        ...
        return yield shared_1.Node.getConnection()
