...
export declare namespace SplToken {
    const createMintInstruction: (connection: Connection, mint: PublicKey, owner: PublicKey, totalAmount: number, mintDecimal: number, tokenMetadata: _TokenMetadata, feePayer: PublicKey, isMutable: boolean) => Promise<import("@solana/web3.js").TransactionInstruction[]>;
