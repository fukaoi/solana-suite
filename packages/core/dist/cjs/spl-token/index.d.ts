...
export declare const SplToken: {
    ...
    createMintInstruction: (connection: import("@solana/web3.js").Connection, owner: import("@solana/web3.js").PublicKey, signers: import("@solana/web3.js").Keypair[], totalAmount: number, mintDecimal: number, tokenMetadata: import("@metaplex-foundation/mpl-token-metadata").DataV2, feePayer: import("@solana/web3.js").Keypair, isMutable: boolean) => Promise<import("@solana-suite/shared").MintInstruction>;
    mint: (owner: import("@solana/web3.js").PublicKey, signer: import("@solana/web3.js").Keypair, totalAmount: number, mintDecimal: number, input: import("@solana-suite/shared-metaplex").InputTokenMetadata, feePayer?: import("@solana/web3.js").Keypair | undefined) => Promise<import("@solana-suite/shared").Result<import("@solana-suite/shared").MintInstruction, Error>>;
