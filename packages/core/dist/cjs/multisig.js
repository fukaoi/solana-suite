...
(function (Multisig) {
    ...
    Multisig.create = (m, feePayer, signerPubkey) => __awaiter(this, void 0, void 0, function* () {
        ...
        const balanceNeeded = yield connection
            .getMinimumBalanceForRentExemption(_multisig_1.Internals_Multisig.Layout.span)
            .then(shared_1.Result.ok)
            .catch(shared_1.Result.err);
        if (balanceNeeded.isErr)
            return shared_1.Result.err(balanceNeeded.error);
        const inst1 = _multisig_1.Internals_Multisig.account(account, feePayer, balanceNeeded.value);
