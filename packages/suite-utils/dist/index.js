...
((Account5) => {
  ...
  ((Pda2) => {
    ...
    Pda2.getTreeAuthority = (address) => {
      const [publicKey] = import_web310.PublicKey.findProgramAddressSync(
        [address.toPublicKey().toBuffer()],
        import_mpl_bubblegum_instruction2.PROGRAM_ADDRESS.toPublicKey()
      );
      return publicKey;
    };
    Pda2.getBgumSigner = () => {
