...
__export(src_exports, {
  PhantomRegularNft: () => PhantomRegularNft2,
  PhantomSplToken: () => PhantomSplToken3,
  UseMethod: () => UseMethod
});
...
((PhantomSplToken4) => {
  PhantomSplToken4.add = async (token, owner, cluster, totalAmount, mintDecimal, phantom) => {
    return Try(async () => {
      ...
      transaction.add(
        (0, import_spl_token13.createMintToCheckedInstruction)(
          token.toPublicKey(),
...
((PhantomSplToken4) => {
  PhantomSplToken4.mint = async (input, owner, cluster, totalAmount, mintDecimal, phantom) => {
    return Try(async () => {
      Node.changeConnection({ cluster });
      const connection = Node.getConnection();
      const transaction = new import_web319.Transaction();
      const mint2 = import_web319.Keypair.generate();
      input.royalty = 0;
      const sellerFeeBasisPoints = 0;
