...
var Constants3;
((Constants24) => {
  Constants24.currentCluster = Config3.cluster.type;
  Constants24.customClusterUrl = Config3.cluster.customClusterUrl;
  Constants24.isDebugging = Config3.debugging;
  Constants24.nftStorageApiKey = Config3.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants24.WRAPPED_TOKEN_PROGRAM_ID = new PublicKey3(
    "So11111111111111111111111111111111111111112"
  );
  Constants24.MEMO_PROGRAM_ID = new PublicKey3(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants24.METAPLEX_PROGRAM_ID = new PublicKey3(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants24.COMMITMENT = "confirmed";
  Constants24.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants24.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants24.BUNDLR_NETWORK_URL = (0, Constants24.switchBundlr)(Config3.cluster.type);
...
import { Keypair, PublicKey as PublicKey32 } from "@solana/web3.js";
import bs from "bs58";
import { PublicKey as PublicKey42 } from "@solana/web3.js";
import { PROGRAM_ID } from "@metaplex-foundation/mpl-token-metadata";
var Constants4;
((Constants222) => {
  Constants222.currentCluster = Config4.cluster.type;
  Constants222.customClusterUrl = Config4.cluster.customClusterUrl;
  Constants222.isDebugging = Config4.debugging;
  Constants222.nftStorageApiKey = Config4.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants222.WRAPPED_TOKEN_PROGRAM_ID = new PublicKey4(
    "So11111111111111111111111111111111111111112"
  );
  Constants222.MEMO_PROGRAM_ID = new PublicKey4(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants222.METAPLEX_PROGRAM_ID = new PublicKey4(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  ...
  Constants222.BUNDLR_NETWORK_URL = (0, Constants222.switchBundlr)(Config4.cluster.type);
...
((PhantomMetaplex2) => {
  PhantomMetaplex2.mint = async (input, cluster, phantom) => {
    return Try2(async () => {
      ...
      const properties = await Converter82.Properties.intoInfraSide(
        input.properties,
        Storage.uploadContent,
        input.storageType
      );
      const sellerFeeBasisPoints = Converter82.Royalty.intoInfraSide(
        input.royalty
      );
      ...
      const datav2 = Converter82.NftMetadata.intoInfraSide(
        input,
        uri,
        sellerFeeBasisPoints
      );
...
import { Keypair as Keypair2, Transaction as Transaction3 } from "@solana/web3.js";
...
((PhantomSplToken4) => {
  PhantomSplToken4.mint = async (input, owner, cluster, totalAmount, mintDecimal, phantom) => {
    return Try2(async () => {
      ...
      const isMutable = true;
      const datav2 = Converter82.TokenMetadata.intoInfraSide(
        input,
        uri,
        sellerFeeBasisPoints
      );
      debugLog3("# datav2: ", datav2);
      debugLog3("# upload content url: ", uri);
