...
((RegularNft12) => {
  const NFT_AMOUNT = 1;
  const NFT_DECIMALS = 0;
  RegularNft12.gasLessTransfer = async (mint, owner, dest, feePayer, options = {}) => {
...
import { Keypair as Keypair5, Transaction as Transaction10 } from "@solana/web3.js";
