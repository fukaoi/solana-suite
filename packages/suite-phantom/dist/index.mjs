...
// ../global/src/index.ts
import { Keypair as Keypair2, LAMPORTS_PER_SOL, PublicKey as PublicKey4 } from "@solana/web3.js";
...
((PhantomMetaplex2) => {
  PhantomMetaplex2.mint = async (input, cluster, phantom) => {
    return Try(async () => {
      ...
      const datav2 = Converter12.NftMetadata.intoInfra(
        input,
        uri,
        sellerFeeBasisPoints
      );
      ...
      const insts = await RegularNft9.createMintInstructions(
        mint2.toPublicKey(),
        phantom.publicKey,
        datav2,
        phantom.publicKey,
...
import { Keypair as Keypair6, Transaction as Transaction9 } from "@solana/web3.js";
...
((PhantomSplToken4) => {
  PhantomSplToken4.mint = async (input, owner, cluster, totalAmount, mintDecimal, phantom) => {
    return Try(async () => {
      ...
      debugLog("# datav2: ", datav2);
      debugLog("# upload content url: ", uri);
      const insturctions = await SplToken11.createMintInstructions(
        mint2.publicKey,
        owner.toPublicKey(),
        totalAmount,
        mintDecimal,
