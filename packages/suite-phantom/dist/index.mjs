...
// src/regular-nft/mint.ts
var PhantomRegularNft;
((PhantomRegularNft3) => {
  PhantomRegularNft3.mint = async (input, cluster, phantom) => {
    return Try(async () => {
      const valid = Validator.checkAll(input);
      if (valid.isErr) {
        throw valid.error;
...
})(PhantomRegularNft || (PhantomRegularNft = {}));

// src/regular-nft/index.ts
var PhantomRegularNft2 = { ...PhantomRegularNft };
...
var PhantomSplToken;
((PhantomSplToken4) => {
  PhantomSplToken4.add = async (token, owner, cluster, totalAmount, mintDecimal, phantom) => {
    return Try(async () => {
      Node.changeConnection({ cluster });
      const connection = Node.getConnection();
...
import { Keypair as Keypair7, Transaction as Transaction11 } from "@solana/web3.js";
...
((PhantomSplToken4) => {
  PhantomSplToken4.mint = async (input, owner, cluster, totalAmount, mintDecimal, phantom) => {
    return Try(async () => {
      Node.changeConnection({ cluster });
      const connection = Node.getConnection();
      const transaction = new Transaction11();
      const mint2 = Keypair7.generate();
      input.royalty = 0;
      const sellerFeeBasisPoints = 0;
...
// ../types/src/regular-nft/common.ts
