...
(function (Metaplex) {
    ...
    Metaplex.uploadContentMint = (input, owner, feePayer) => __awaiter(this, void 0, void 0, function* () {
        const upload = yield StorageArweave.uploadContent(input.filePath, feePayer);
        input.filePath = upload.unwrap();
        const uploadMetadata = yield StorageArweave.uploadMetadata(input, feePayer);
    ...
    const createNft = (operation, mint, owner, feePayer) => __awaiter(this, void 0, void 0, function* () {
        const { uri, isMutable, maxSupply, payer = feePayer, mintAuthority = feePayer, updateAuthority = mintAuthority, freezeAuthority, tokenProgram = TOKEN_PROGRAM_ID, associatedTokenProgram, } = operation.input;
