...
import { debugLog, Try, MintInstruction, Node, PartialSignInstruction, } from '@solana-suite/shared';
...
(function (Metaplex) {
    ...
    const createNftBuilder = (params, owner) => __awaiter(this, void 0, void 0, function* () {
        const useNewMint = Keypair.generate();
        const updateAuthority = owner;
        const mintAuthority = owner;
        const tokenOwner = owner.publicKey;
        const inst = yield Metaplex.createNftBuilderInstruction(owner, params, useNewMint, updateAuthority, mintAuthority, tokenOwner);
        return new MintInstruction(inst, [useNewMint, owner], undefined, useNewMint.publicKey.toString());
    });
    ...
    Metaplex.createNftBuilderInstruction = (owner, params, useNewMint, updateAuthority, mintAuthority, tokenOwner) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        debugLog('# params: ', params);
        debugLog('# feePayer: ', owner === null || owner === void 0 ? void 0 : owner.publicKey.toString());
     ...
     */
    Metaplex.feePayerPartialSignMint = (input, owner, feePayer) => __awaiter(this, void 0, void 0, function* () {
        return Try(() => __awaiter(this, void 0, void 0, function* () {
            const valid = Validator.checkAll(input);
            if (valid.isErr) {
                throw valid.error;
            }
            const uploaded = yield Metaplex.uploadMetaContent(input, owner);
