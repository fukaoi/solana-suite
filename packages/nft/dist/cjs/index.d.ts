...
export declare const Metaplex: {
    ...
    findByOwner: (owner: import("@solana/web3.js").PublicKey) => Promise<import("@solana-suite/shared").Result<import("./types").OutputMetaplexMetadata[], Error>>;
    uploadMetaContent: (input: import("./types").InputMetaplexMetadata, feePayer: import("@solana-suite/shared").BundlrSigner) => Promise<{
        uri: string;
    ...
    mint: (input: import("./types").InputMetaplexMetadata, owner: import("@solana/web3.js").Keypair, feePayer?: import("@solana/web3.js").Keypair | undefined) => Promise<import("@solana-suite/shared").Result<import("@solana-suite/shared").MintInstruction, Error>>;
};
