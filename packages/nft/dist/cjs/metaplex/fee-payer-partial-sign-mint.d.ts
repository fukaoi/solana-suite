...
export declare namespace Metaplex {
    ...
    const createNftBuilderInstruction: (owner: BundlrSigner, params: CreateNftBuilderParams, useNewMint: Keypair, updateAuthority: Keypair | IdentityClient, mintAuthority: Keypair | IdentityClient, tokenOwner: PublicKey) => Promise<TransactionInstruction[]>;
    /**
     ...
     */
    const feePayerPartialSignMint: (input: InputMetaplexMetadata, owner: Keypair, feePayer: PublicKey) => Promise<Result<PartialSignInstruction, Error>>;
}
