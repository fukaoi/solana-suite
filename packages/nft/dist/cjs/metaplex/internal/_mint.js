...
exports.MetaplexInternal_Mint = void 0;
...
// @internal
var MetaplexInternal_Mint;
(function (MetaplexInternal_Mint) {
    /**
     * NFT mint
     *
     ...
     */
    MetaplexInternal_Mint.create = (metadata, owner, feePayer) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (metadata.sellerFeeBasisPoints) {
            metadata.sellerFeeBasisPoints = royalty_1.MetaplexRoyalty.convertValue(metadata.sellerFeeBasisPoints);
        }
...
})(MetaplexInternal_Mint = exports.MetaplexInternal_Mint || (exports.MetaplexInternal_Mint = {}));
