  ...
  ((TokenMetadata2) => {
    ...
    TokenMetadata2.intoUser = (output, tokenAmount) => {
      return {
        ...
        uses: Converter7.Uses.intoUserSide(output.onchain.uses),
  ...
  ((NftMetadata2) => {
    ...
    NftMetadata2.intoUser = (output, tokenAmount) => {
      return {
        ...
        royalty: output.onchain.data.sellerFeeBasisPoints,
        name: Converter8.TokenMetadata.deleteNullStrings(output.onchain.data.name),
        symbol: Converter8.TokenMetadata.deleteNullStrings(
          output.onchain.data.symbol
        ),
        tokenAmount,
        uri: Converter8.TokenMetadata.deleteNullStrings(output.onchain.data.uri),
        isMutable: output.onchain.isMutable,
        primarySaleHappened: output.onchain.primarySaleHappened,
        creators: Converter2.Creators.intoUser(output.onchain.data.creators),
        editionNonce: output.onchain.editionNonce,
        collection: Converter.Collection.intoUser(output.onchain.collection),
        collectionDetails: Converter6.CollectionDetails.intoUser(
