...
((Validator2) => {
  ...
  Validator2.isSellerFeeBasisPoints = (royalty) => {
    return Try(() => {
      ...
      } else if (royalty > Validator2.ROYALTY_MAX * Converter3.Royalty.THRESHOLD) {
        throw createError(key, Message.BIG_NUMBER, royalty, {
