export declare const SolNative: {
    transferWithMultisig: (owner: import("shared").Pubkey, dest: import("shared").Pubkey, signers: import("shared").Secret[], amount: number, feePayer?: import("shared").Secret | undefined) => Promise<import("shared").Result<import("shared").Instruction, Error>>;
    transfer: (source: import("shared").Pubkey, dest: import("shared").Pubkey, signers: import("shared").Secret[], amount: number, feePayer?: import("shared").Secret | undefined) => import("shared").Result<import("shared").Instruction, Error>;
