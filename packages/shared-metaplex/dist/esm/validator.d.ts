...
import { InputNftMetadata, MetaplexNftMetaData, NftStorageMetadata } from './types/';
...
export declare namespace Validator {
    ...
    type PickMetaplex = Pick<MetaplexNftMetaData, 'name' | 'symbol' | 'uri' | 'sellerFeeBasisPoints'>;
    export {};
}
