...
(function (Pda) {
    Pda.getMetadata = (mint) => {
        const [publicKey] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from('metadata'), mpl_token_metadata_1.PROGRAM_ID.toBuffer(), mint.toBuffer()], mpl_token_metadata_1.PROGRAM_ID);
        return publicKey;
    };
