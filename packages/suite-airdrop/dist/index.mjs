...
((Airdrop2) => {
  ...
  Airdrop2.request = async (pubkey, airdropAmount) => {
    return Try(async () => {
      ...
      const sig = await Node3.getConnection().requestAirdrop(
        pubkey.toPublicKey(),
        airdropAmount
      );
