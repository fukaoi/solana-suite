...
_Instruction.batchSubmit = (arr) => __async(_Instruction, null, function* () {
  ...
  return yield (0, import_web33.sendAndConfirmTransaction)(
    Node.getConnection(),
    transaction,
    finalSigners,
    options
...
// src/instruction/index.ts
var Instruction2 = class _Instruction2 {
  constructor(instructions, signers, feePayer, data) {
    this.submit = () => __async(this, null, function* () {
      return Try(() => __async(this, null, function* () {
        ...
        return yield (0, import_web36.sendAndConfirmTransaction)(
          Node.getConnection(),
          transaction,
          finalSigners,
          options
