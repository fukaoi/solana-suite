...
var ProvenanceLayer;
((ProvenanceLayer2) => {
  ProvenanceLayer2.upload = () => {
  };
  const TOKEN = "solana";
  ProvenanceLayer2.toBuffer = async (content) => {
    let buffer;
  ...
  ProvenanceLayer2.getIrys = async (secret) => {
  ...
  ProvenanceLayer2.getWebIrys = async (provider) => {
    const url = Constants.BUNDLR_NETWORK_URL;
    const token = TOKEN;
    const clusterUrl = Constants.currentCluster;
