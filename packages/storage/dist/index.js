...
((ProvenanceLayer2) => {
  const TOKEN = "solana";
  ProvenanceLayer2.uploadFile = (uploadFile2, identity) => {
    Try(async () => {
      ...
      let receipt;
      if (isNode() && typeof uploadFile2 === "string") {
        receipt = await irys.uploadFile(uploadFile2, { tags });
      } else if (isBrowser() && typeof uploadFile2 !== "string") {
        receipt = await irys.uploadFile(uploadFile2, { tags });
      }
  ...
  ProvenanceLayer2.getIrys = async (identity) => {
    return isNode() ? await (0, ProvenanceLayer2.getNodeIrys)(identity) : await (0, ProvenanceLayer2.getBrowserIrys)(identity);
  };
