...
((CompressedNft10) => {
  ...
  CompressedNft10.initTree = (feePayer, maxDepth, maxBufferSize) => {
    return Try(async () => {
  ...
  CompressedNft10.initMintTotal = async (total, feePayer) => {
    ...
    return (0, CompressedNft10.initTree)(feePayer, matched.maxDepth, matched.maxBufferSize);
  };
  CompressedNft10.calculateSpaceCost = async (space) => {
    const lamports = await Node.getConnection().getMinimumBalanceForRentExemption(space);
