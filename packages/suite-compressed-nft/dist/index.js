...
((CompressedNft7) => {
  CompressedNft7.createVerifyCreatorsInstruction = async (creators, assetId, treeOwner, metadata, feePayer) => {
    ...
    return (0, import_mpl_bubblegum_instruction3.createVerifyCreatorInstruction)(
      {
      ...
      },
      {
        ...
        creatorHash: [...(0, import_mpl_bubblegum_instruction3.computeCreatorHash)(creators)],
        dataHash: [...(0, import_mpl_bubblegum_instruction3.computeDataHash)(metadata)],
  ...
  CompressedNft7.mint = async (owner, signer, input, treeOwner, collectionMint, feePayer, receiver) => {
    return Try(async () => {
      ...
      const instructions = [];
      instructions.push(
        (0, import_mpl_bubblegum_instruction3.createMintToCollectionV1Instruction)(
          {
...
((CompressedNft7) => {
  CompressedNft7.transfer = async (assetId, owner, dest, signer, feePayer) => {
    return Try(async () => {
      ...
      let inst = (0, import_mpl_bubblegum_instruction4.createTransferInstruction)(
        {
          merkleTree,
          treeAuthority,
          leafOwner,
