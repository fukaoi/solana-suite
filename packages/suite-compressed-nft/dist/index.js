...
((CompressedNft10) => {
  CompressedNft10.gasLessTransfer = async (assetId, assetIdOwner, dest, feePayer) => {
    return Try(async () => {
      ...
      const second = new TransactionBuilder5.PartialSign(
        inst.serialize({
          requireAllSignatures: false
        }).toString("hex")
      );
