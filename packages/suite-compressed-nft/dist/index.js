...
((Filebase2) => {
  ...
  const LOG_LEVEL = Constants.isDebugging == "true" || process.env.DEBUG === "true" ? "debug" : "warn";
  ...
  const connect = () => {
    return new import_client_s3.S3Client({
      ...
      region: "us-east-1",
      logger: (0, import_pino.default)({ level: LOG_LEVEL })
    });
  };
