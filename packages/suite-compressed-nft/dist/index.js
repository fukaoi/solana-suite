...
String.prototype.toPublicKey = function() {
  ...
  return new import_web33.PublicKey(this.toString());
};
...
Number.prototype.toSol = function() {
  return (0, import_bignumber.BigNumber)(this).div(import_web33.LAMPORTS_PER_SOL).toNumber();
};
Number.prototype.toLamports = function() {
  return (0, import_bignumber.BigNumber)(this).times(import_web33.LAMPORTS_PER_SOL).toNumber();
};
...
((CompressedNft5) => {
  ...
  CompressedNft5.Tree = Tree;
  CompressedNft5.initTree = (feePayer, maxDepth = 14, maxBufferSize = 64) => {
    return Try(async () => {
      ...
      const inst2 = (0, import_mpl_bubblegum_instruction2.createCreateTreeInstruction)(
        {
...
var CompressedNft2;
((CompressedNft5) => {
  CompressedNft5.mint = async (owner, signer, input, treeOwner, collectionMint, feePayer, receiver, freezeAuthority) => {
    ...
    let datav2 = Converter14.CompressedNftMetadata.intoInfra(
      input,
      uri,
      sellerFeeBasisPoints
    );
    ...
    const instruction = (0, import_mpl_bubblegum_instruction3.createMintToCollectionV1Instruction)(
      {
        ...
        collectionAuthorityRecordPda: import_mpl_bubblegum_instruction3.PROGRAM_ID,
    ...
    return new MintTransaction(
      ...
      [signer.toKeypair()],
      payer.toKeypair(),
      new CompressedNft.Tree(treeOwner)
    );
  };
...
var CompressedNft3;
((CompressedNft5) => {
  CompressedNft5.mintCollection = (owner, signer, input, feePayer, freezeAuthority) => {
...
// src/index.ts
var CompressedNft4 = { ...CompressedNft2, ...CompressedNft, ...CompressedNft3 };
