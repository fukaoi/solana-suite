...
((Constants3) => {
  ...
  ((WarnningMessage2) => {
    ...
    WarnningMessage2.DAS_API_URL = `
        ...
        -------------------------------------- 
        `;
  })(WarnningMessage = Constants3.WarnningMessage || (Constants3.WarnningMessage = {}));
})(Constants || (Constants = {}));
((Constants3) => {
  Constants3.currentCluster = Config.cluster.type;
  Constants3.customClusterUrl = Config.cluster.customClusterUrl;
  Constants3.isDebugging = Config.debugging;
  Constants3.customNftStorageApiKey = Config.nftStorageApiKey;
  Constants3.customDasApiUrl = Config.dasApiUrl;
  let Cluster;
  ((Cluster2) => {
  ...
  })(Cluster = Constants3.Cluster || (Constants3.Cluster = {}));
  let EndPointUrl;
  ((EndPointUrl2) => {
  ...
  })(EndPointUrl = Constants3.EndPointUrl || (Constants3.EndPointUrl = {}));
  let BundlrUrl;
  ((BundlrUrl2) => {
    BundlrUrl2["prd"] = "https://node1.irys.xyz,https://node2.irys.xyz";
    BundlrUrl2["dev"] = "https://devnet.irys.xyz";
  })(BundlrUrl = Constants3.BundlrUrl || (Constants3.BundlrUrl = {}));
  let DasApiUrl;
  ((DasApiUrl2) => {
  ...
  })(DasApiUrl = Constants3.DasApiUrl || (Constants3.DasApiUrl = {}));
  ...
  })(NftstorageApiKey = Constants3.NftstorageApiKey || (Constants3.NftstorageApiKey = {}));
  Constants3.switchCluster = (param) => {
  ...
  Constants3.switchDasApi = (env) => {
    if (Constants3.customDasApiUrl && Constants3.customDasApiUrl.length > 0) {
      const index = Date.now() % Constants3.customDasApiUrl.length;
      return Constants3.customDasApiUrl[index];
    }
    switch (env) {
      case "mainnet-beta" /* prd */: {
        if (Constants3.customDasApiUrl.length < 1) {
          console.warn(Constants3.WarnningMessage.DAS_API_URL);
        }
  ...
  Constants3.switchNftStorage = (env) => {
    if (Constants3.customNftStorageApiKey) {
      return Constants3.customNftStorageApiKey;
    }
    switch (env) {
      case "mainnet-beta" /* prd */:
  ...
  Constants3.loadConfig = async () => {
    Config = await import("@solana-suite/config/load");
  };
  Constants3.WRAPPED_TOKEN_PROGRAM_ID = new import_web3.PublicKey(
    "So11111111111111111111111111111111111111112"
  );
  Constants3.MEMO_PROGRAM_ID = new import_web3.PublicKey(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants3.METAPLEX_PROGRAM_ID = new import_web3.PublicKey(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants3.COMMITMENT = "confirmed";
  Constants3.MAX_TRANSACTION_VERSION = 0;
  Constants3.MAX_TRANSACTION_RETRIES = 1;
  Constants3.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants3.IRYS_GATEWAY_URL = "https://gateway.irys.xyz";
  Constants3.BUNDLR_NETWORK_URL = (0, Constants3.switchBundlr)(Config.cluster.type);
  Constants3.DAS_API_URL = (0, Constants3.switchDasApi)(Config.cluster.type);
  Constants3.NFT_STORAGE_API_KEY = (0, Constants3.switchNftStorage)(Config.cluster.type);
  Constants3.EXPLORER_SOLSCAN_URL = "https://solscan.io";
  Constants3.EXPLORER_SOLANAFM_URL = "https://solana.fm";
  Constants3.EXPLORER_XRAY_URL = "https://xray.helius.xyz";
})(Constants || (Constants = {}));
...
((CompressedNft10) => {
  ...
  CompressedNft10.initSpace = (owner, maxDepth, maxBufferSize, canopyDepth, options = {}) => {
    return Try(async () => {
      ...
      const space = (0, import_spl_account_compression4.getConcurrentMerkleTreeAccountSize)(
        maxDepth,
        maxBufferSize,
        canopyDepth
      );
      const [treeAuthority] = import_web317.PublicKey.findProgramAddressSync(
        ...
        import_mpl_bubblegum_instructions5.PROGRAM_ADDRESS.toPublicKey()
      );
      const instructions = [];
      ...
      instructions.push(
        import_web317.SystemProgram.createAccount({
          ...
          space,
          programId: import_spl_account_compression4.SPL_ACCOUNT_COMPRESSION_PROGRAM_ID
        })
      );
      instructions.push(
        (0, import_mpl_bubblegum_instructions5.createCreateTreeInstruction)(
          {
  ...
  CompressedNft10.calculateSpaceCost = async (spaceSize) => {
    const { maxDepth, maxBufferSize, canopyDepth } = calculateSpaceNumberToDepth(spaceSize);
    const requiredSpace = (0, import_spl_account_compression4.getConcurrentMerkleTreeAccountSize)(
      maxDepth,
      maxBufferSize,
      canopyDepth
    );
  ...
  const calculateSpaceNumberToDepth = (space) => {
    ...
    const matched = import_spl_account_compression4.ALL_DEPTH_SIZE_PAIRS.filter(
