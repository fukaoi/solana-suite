  ...
  if (feePayer) {
    ...
    for (const obj of this) {
      if (obj.isErr) {
        ...
        return Result5.err(Error("Only Array Instruction object"));
      }
    }
