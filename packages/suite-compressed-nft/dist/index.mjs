...
var CompressedNft5;
((CompressedNft10) => {
  CompressedNft10.gasLessTransfer = async (mint, signer, dest, feePayer) => {
    ...
    const transfer = await Try(async () => {
      ...
      const assetIdOwnerKeypair = new Account4.Keypair({ secret: signer });
      inst.add(
...
((CompressedNft10) => {
  ...
  CompressedNft10.initTree = (owner, signer, maxDepth, maxBufferSize, canopyDepth, options = {}) => {
    return Try(async () => {
  ...
  CompressedNft10.createMintSpace = async (owner, signer, spaceSize, options = {}) => {
    ...
    return (0, CompressedNft10.initTree)(
      owner,
      signer,
      maxDepth,
      maxBufferSize,
