...
((Node32) => {
  ...
  Node32.confirmedSig = async (signature, commitment = Constants.COMMITMENT) => {
    const connection = Node32.getConnection();
    const latestBlockhash = await connection.getLatestBlockhash();
    return await connection.confirmTransaction(
      {
        blockhash: latestBlockhash.blockhash,
...
// src/instruction/index.ts
var Instruction3 = class _Instruction {
  instructions;
  signers;
  feePayer;
  data;
...
var MintInstruction = class _MintInstruction extends Instruction3 {
  constructor(instructions, signers, feePayer, data) {
  ...
  submit = async () => {
    return Try2(async () => {
      ...
      if (Node2.getConnection().rpcEndpoint === Constants2.EndPointUrl.prd) {
        debugLog2("# Change metaplex cluster on mainnet-beta");
        Node2.changeConnection({ cluster: Constants2.Cluster.prdMetaplex });
      }
...
var PartialSignInstruction = class _PartialSignInstruction {
  ...
  submit = async (feePayer) => {
    return Try2(async () => {
      ...
      const transactionFromJson = Transaction8.from(decode);
