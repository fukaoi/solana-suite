...
var Constants3;
((Constants22) => {
  Constants22.currentCluster = Config3.cluster.type;
  Constants22.customClusterUrl = Config3.cluster.customClusterUrl;
  Constants22.isDebugging = Config3.debugging;
  Constants22.nftStorageApiKey = Config3.nftstorage.apikey;
  let Cluster;
  ((Cluster2) => {
    Cluster2["prd"] = "mainnet-beta";
    Cluster2["prdMetaplex"] = "mainnet-beta-metaplex";
  ...
  Constants22.WRAPPED_TOKEN_PROGRAM_ID = new PublicKey4(
    "So11111111111111111111111111111111111111112"
  );
  Constants22.MEMO_PROGRAM_ID = new PublicKey4(
    "Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo"
  );
  Constants22.METAPLEX_PROGRAM_ID = new PublicKey4(
    "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s"
  );
  Constants22.COMMITMENT = "confirmed";
  Constants22.NFT_STORAGE_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGMjcyN2VkODZhRGU1RTMyZDZDZEJlODc0YzRFNDlEODY1OWZmOEMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTYyMDI2NDk0MzcwNiwibmFtZSI6ImRlbW8ifQ.d4J70mikxRB8a5vwNu6SO5HDA8JaueuseAj7Q_ytMCE";
  Constants22.NFT_STORAGE_GATEWAY_URL = "https://ipfs.io/ipfs";
  Constants22.BUNDLR_NETWORK_URL = (0, Constants22.switchBundlr)(Config3.cluster.type);
...
var MintInstruction = class _MintInstruction extends Instruction2 {
  ...
  submit = async () => {
    return Try(async () => {
      ...
      if (Node.getConnection().rpcEndpoint === Constants3.EndPointUrl.prd) {
        debugLog2("# Change metaplex cluster on mainnet-beta");
        Node.changeConnection({ cluster: Constants3.Cluster.prdMetaplex });
      }
