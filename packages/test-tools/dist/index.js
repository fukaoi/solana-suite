...
var requestSol = async (pubkey, sol = 0.1) => {
  ...
  const keypair = JSON.parse(
    import_fs.default.readFileSync(LOCAL_KEYPAIR_FILE, "utf8")
  ).feePayer;
