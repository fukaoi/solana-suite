...
[src/node.ts:15](https://github.com/fukaoi/solana-suite/blob/20fd35c/src/node.ts#L15)
...
[src/node.ts:9](https://github.com/fukaoi/solana-suite/blob/20fd35c/src/node.ts#L9)
