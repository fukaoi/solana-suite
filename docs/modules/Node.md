[solana-suite](../README.md) / [Exports](../modules.md) / Node
...
[src/node.ts:15](https://github.com/fukaoi/solana-suite/blob/17adcd0/src/node.ts#L15)
...
[src/node.ts:9](https://github.com/fukaoi/solana-suite/blob/17adcd0/src/node.ts#L9)
